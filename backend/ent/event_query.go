...
type EventQuery struct {
	...
	withCategory      *EventCategoryQuery
	withOccurrences   *EventOccurrenceQuery
	withSourceRecords *EventSourceRecordQuery
	withImportItems   *EventImportItemQuery
...
func (_q *EventQuery) QueryCategory() *EventCategoryQuery {
	query := (&EventCategoryClient{config: _q.config}).Query()
...
func (_q *EventQuery) QueryOccurrences() *EventOccurrenceQuery {
	query := (&EventOccurrenceClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *EventQuery) QuerySourceRecords() *EventSourceRecordQuery {
...
// QueryImportItems chains the current query on the "import_items" edge.
func (_q *EventQuery) QueryImportItems() *EventImportItemQuery {
...
func (_q *EventQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *EventQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *EventQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *EventQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *EventQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *EventQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *EventQuery) Clone() *EventQuery {
	...
	return &EventQuery{
		...
		withImportItems:   _q.withImportItems.Clone(),
...
func (_q *EventQuery) WithCategory(opts ...func(*EventCategoryQuery)) *EventQuery {
	query := (&EventCategoryClient{config: _q.config}).Query()
...
func (_q *EventQuery) WithOccurrences(opts ...func(*EventOccurrenceQuery)) *EventQuery {
	query := (&EventOccurrenceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventQuery) WithSourceRecords(opts ...func(*EventSourceRecordQuery)) *EventQuery {
	query := (&EventSourceRecordClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithImportItems tells the query-builder to eager-load the nodes that are connected to
// the "import_items" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *EventQuery) WithImportItems(opts ...func(*EventImportItemQuery)) *EventQuery {
	query := (&EventImportItemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withImportItems = query
	return _q
}
...
func (_q *EventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Event, error) {
	...
	if query := _q.withCategory; query != nil {
		if err := _q.loadCategory(ctx, query, nodes, nil,
			func(n *Event, e *EventCategory) { n.Edges.Category = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOccurrences; query != nil {
		if err := _q.loadOccurrences(ctx, query, nodes,
			func(n *Event) { n.Edges.Occurrences = []*EventOccurrence{} },
			func(n *Event, e *EventOccurrence) { n.Edges.Occurrences = append(n.Edges.Occurrences, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withSourceRecords; query != nil {
		if err := _q.loadSourceRecords(ctx, query, nodes,
			func(n *Event) { n.Edges.SourceRecords = []*EventSourceRecord{} },
			func(n *Event, e *EventSourceRecord) { n.Edges.SourceRecords = append(n.Edges.SourceRecords, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withImportItems; query != nil {
		if err := _q.loadImportItems(ctx, query, nodes,
			func(n *Event) { n.Edges.ImportItems = []*EventImportItem{} },
			func(n *Event, e *EventImportItem) { n.Edges.ImportItems = append(n.Edges.ImportItems, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *EventQuery) loadCategory(ctx context.Context, query *EventCategoryQuery, nodes []*Event, init func(*Event), assign func(*Event, *EventCategory)) error {
	...
	query.Where(eventcategory.IDIn(ids...))
...
func (_q *EventQuery) loadOccurrences(ctx context.Context, query *EventOccurrenceQuery, nodes []*Event, init func(*Event), assign func(*Event, *EventOccurrence)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(eventoccurrence.FieldEventID)
	}
	query.Where(predicate.EventOccurrence(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.OccurrencesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) loadSourceRecords(ctx context.Context, query *EventSourceRecordQuery, nodes []*Event, init func(*Event), assign func(*Event, *EventSourceRecord)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(eventsourcerecord.FieldEventID)
	}
	query.Where(predicate.EventSourceRecord(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.SourceRecordsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) loadImportItems(ctx context.Context, query *EventImportItemQuery, nodes []*Event, init func(*Event), assign func(*Event, *EventImportItem)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(eventimportitem.FieldEventID)
	}
	query.Where(predicate.EventImportItem(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.ImportItemsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCategory != nil {
			_spec.Node.AddColumnOnce(event.FieldCategoryID)
		}
	}
