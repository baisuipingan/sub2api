    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M6.75 3v2.25M17.25 3v2.25M3 9.75h18M5.25 5.25h13.5A2.25 2.25 0 0121 7.5v11.25A2.25 2.25 0 0118.75 21H5.25A2.25 2.25 0 013 18.75V7.5a2.25 2.25 0 012.25-2.25z'
        })
      ]
    )
}
...
const flagEventCenter = makeSidebarFlag(FeatureFlags.eventCenter)
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/events', label: t('nav.events'), icon: CalendarIcon, hideInSimpleMode: true, featureFlag: flagEventCenter },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/events', label: t('nav.eventManagement'), icon: CalendarIcon },
